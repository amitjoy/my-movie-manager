 ...
 *
 */
public class IDColumnSpecificBadgeLabelProvider extends ColumnLabelProvider {

	private TableViewer tableViewer;
	private int index;

	public IDColumnSpecificBadgeLabelProvider(TableViewer tableViewer) {
		super();
	...
	public void update(ViewerCell cell) {
		...
		index = tableViewer.getTable().indexOf(
				(TableItem) cell.getItem());
		super.update(cell);
	}
